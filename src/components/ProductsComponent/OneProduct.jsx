...
const OneProduct = ({id,customerName,productName,partName,stageName,whole,inventory}) => {
    return ( 
            <div className={`flex items-center gap-2 bg-primary_cream rounded-sm p-2 shadow-md shadow-primary_light_green ${inventory>0 ?'border-r-8 border-green-500':'border-r-8 border-red-500'}`}>
                <div className="flex flex-col gap-2 flex-1">
                        ...
                        <p><span className="font-bold">inventory:</span> {inventory}</p>
